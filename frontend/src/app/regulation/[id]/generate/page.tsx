    ...
    <div className="space-y-6">
      ...
      {reg && (
        <div className="bg-slate-50 rounded-xl p-4 border border-slate-200">
          <div className="text-xs text-slate-400 mb-1">문서 생성 대상</div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            {done && (
              <div className="flex gap-1.5">
                <button
                  ...
                  className="px-2.5 py-1 text-xs bg-slate-200 text-slate-600 rounded hover:bg-slate-300 transition-colors"
                >
                  {editing ? "미리보기" : "편집"}
                </button>
                <button
          ...
          {editing ? (
            <textarea
              ...
              className="w-full p-6 text-sm text-slate-700 min-h-[500px] focus:outline-none resize-y font-mono"
            />
          ) : (
            <div className="p-6 min-h-[300px] prose prose-slate prose-sm max-w-none prose-headings:text-slate-800 prose-h1:text-xl prose-h1:font-bold prose-h1:border-b prose-h1:border-slate-200 prose-h1:pb-2 prose-h1:mb-4 prose-h2:text-lg prose-h2:font-bold prose-h2:mt-6 prose-h2:mb-3 prose-h3:text-base prose-h3:font-semibold prose-h3:mt-5 prose-h3:mb-2 prose-p:text-slate-600 prose-p:leading-relaxed prose-p:mb-3 prose-li:text-slate-600 prose-li:leading-relaxed prose-strong:text-slate-800 prose-hr:my-6 prose-ul:my-2 prose-ol:my-2">
